...
#undef SSP_FIRMWARE_REVISION_BCM
		...
		#define SSP_FIRMWARE_REVISION_BCM	16100701 /*ANDROID M*/
	#elif ANDROID_VERSION < 80000
		#define SSP_FIRMWARE_REVISION_BCM	17090700  /*ANDROID N*/
	#elif ANDROID_VERSION < 90000
		#define SSP_FIRMWARE_REVISION_BCM	18032000 /*ANDROID O*/
	#else 
