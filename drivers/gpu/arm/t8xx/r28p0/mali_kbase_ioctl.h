...
#define SLSI_SECURE_FLAG_SET	0x1
#define SLSI_SECURE_FLAG_UNSET	0x2
...
#define KBASE_IOCTL_SLSI_SECURE_FLAGS \
   _IOW(KBASE_IOCTL_TYPE, 44, struct kbase_ioctl_slsi_secure_flag)
